...
module.exports=function(t){function e(o){if(n[o])return n[o].exports;var r=n[o]={i:o,l:!1,exports:{}};return t[o].call(r.exports,r,r.exports,e),r.l=!0,r.exports}var n={};return e.m=t,e.c=n,e.d=function(t,n,o){e.o(t,n)||Object.defineProperty(t,n,{configurable:!1,enumerable:!0,get:o})},e.n=function(t){var n=t&&t.__esModule?function(){return t.default}:function(){return t};return e.d(n,"a",n),n},e.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},e.p="",e(e.s=2)}([function(t,e){var n={},o=o||void 0,r=o?o.getComputedStyle(document.body):{};n.transform=r.webkitTransform?"webkitTransform":r.MozTransform?"MozTransform":r.msTransform?"msTransform":"transform",n.userSelect=r.webkitUserSelect?"webkitUserSelect":r.MozUserSelect?"MozUserSelect":r.msUserSelect?"msUserSelect":"transform";t.exports={MOUNTED:[],STYLE_NAME:n,IS_OFFSET:["width","height","top","left"],XLINK_NS:"http://www.w3.org/1999/xlink",SVG_NS:"http://www.w3.org/2000/svg",IS_VALUE_DEG:["rotate","rotateX","rotateY","rotateZ"],IS_VALUE_PX:["left","right","top","bottom","marginLeft","marginRight","marginTop","marginBottom","height","width","minHeight","minWidth","maxHeight","maxWidth","paddingLeft","paddingRight","paddingTop","paddingBottom","translate","translateX","translateY","translateZ"],IS_TRANSFORM:["rotateX","rotateY","rotateZ","scale","scaleX","scaleY","scaleZ","translateX","translateY","translateZ"]}},function(t,e,n){const{IS_VALUE_PX:o,IS_VALUE_DEG:r}=n(0);t.exports=function(t,e){return o.indexOf(t)>-1?"number"==typeof e?e+"px":e:r.indexOf(t)>-1?"number"==typeof e?e+"deg":e:e.toString()}},function(t,e,n){function o(){var t=this,e=[arguments[0],arguments[1],arguments[2]],n=h(e[0]),r={},i=[];this.isMounted=!1,this.tagName=n?arguments[0].tagName:"div",this.bus=new l({target:this}),this.refs={},this.isSvg=-1!==["use","svg"].indexOf(this.tagName);for(var f=0,u=e.length;f<u;f++)"string"==typeof e[f]?this.tagName=e[f]:s(e[f])?r=e[f]:Array.isArray(e[f])&&(i=e[f]);for(n?this.node=e[0]:this.isSvg?this.node=document.createElementNS(d,this.tagName):this.node=document.createElement(this.tagName),this.append(i),this.attr(r),f=0,u=o.__onCreate.length;f<u;f++)o.__onCreate[f].call(this);n&&setTimeout(function(){p(t.node)},0)}function r(){}function i(t,e,n){return r.lib[t]?new r.lib[t](e,n):t instanceof Text||t instanceof Comment?t:new o(t,e,n)}const s=n(3),h=n(4),f=n(5),p=n(6),u=n(7),a=n(8),c=n(1),l=n(9),{SVG_NS:d,IS_TRANSFORM:g,STYLE_NAME:y,XLINK_NS:m}=n(0);o.__onAttr={},o.__onCreate=[],o.__extend=function(t){return function(e){return e&&(this.node[t]=e),this.node[t]}},o.prototype.setStyle=function(t){var e={transform:[],default:[]};for(var n in t)if(g.indexOf(n)>-1)if("object"==typeof t[n])for(var o in t[n])e.transform.push(a(o,t[n][o]));else e.transform.push(a(n,t[n]));else this.node.style[y[n]||n]=c(n,t[n]);e.transform.length&&(this.node.style[y.transform]=e.transform.join(" "))},o.prototype.style=function(t){return"object"==typeof t?(this.setStyle(t),this):"string"==typeof t?window.getComputedStyle(this.node)[y[t]||t]:window.getComputedStyle(this.node)},o.prototype.value=function(t){return void 0===t?this.node.value:(this.node.value=t,this)},o.prototype.offset=function(){return this.node.getBoundingClientRect()},o.prototype.classList=function(){var t=this.node.getAttribute("class");return t?t.split(" "):[]},o.prototype.removeClass=function(t){var e=this.classList(),n=e.indexOf(t);return n>-1&&e.splice(n,1),this.node.setAttribute("class",e.join(" ")),this},o.prototype.addClass=function(t){var e=this.classList();return-1===e.indexOf(t)&&e.push(t),this.node.setAttribute("class",e.join(" ")),this},o.prototype.getRoot=function(){return this.node},o.prototype.getEl=function(){return this},o.prototype.focus=function(){return this.node.focus(),this},o.prototype.append=function(t){var e;if(t)for(var n=0,o=(t=[].concat(t)).length;n<o;n++)e=t[n].getRoot?t[n].getRoot():new Text(t[n]),this.getRoot().appendChild(e),p(e),f.call(this,t[n]);return this},o.prototype.prepend=function(t){for(var e=this.node.childNodes[0],n=[].concat(t),o=0,r=n.length;o<r;o++)e.parentNode.insertBefore(n[o].getRoot(),e),f.call(this,n[o])},o.prototype.attr=function(t){var e;if("string"==typeof t)return this.node.getAttribute(t);for(var n in t)e=n.toLowerCase(),"ref"===n?this.ref=t[n]:o.__onAttr[e]?o.__onAttr[e].call(this,t[n]):"style"===n?this.setStyle(t[n]):this.isSvg&&"href"===n?this.node.setAttributeNS(m,n,t[n]):"once"===n.substring(0,4)?this.once(n.substring(4),t[n]):"on"===n.substring(0,2)?this.on(n.substring(2),t[n]):"class"===n?"string"==typeof t[n]&&this.node.setAttribute("class",t[n].split(" ").filter(t=>t.length).map(t=>t.trim()).join(" ")):t[n]&&this.node.setAttribute(n,t[n]);return this},o.prototype.closest=function(t){return i(this.node.closest(t))},o.prototype.find=function(t){return i(this.node.querySelector(t))},o.prototype.findAll=function(t){for(var e=[],n=this.node.querySelectorAll(t),o=0,r=n.length;o<r;o++)e.push(i(n[o]));return e},o.prototype.html=function(t){if("string"!=typeof t)return this.node.innerHTML;if(this.node.innerHTML=t,0===t.length){for(var e=0,n=this.children.length;e<n;e++)delete this.children[e];this.children=[]}else this.children=Array.prototype.map.call(this.node.childNodes,t=>i(t));return this},o.prototype.remove=function(){return this.node.parentNode&&(u(this.node),this.node.parentNode.removeChild(this.node)),this},o.prototype.replaceWith=function(t){var e=t.getRoot();return this.node.parentNode.replaceChild(e,this.node),u(this.node),p(e),this},o.prototype.on=function(t,e){var n=this,o=t.toLowerCase();return"function"==typeof e&&(this.bus.on(o,e),this.node.addEventListener(o,function(t){n.trigger(o,t)},!1)),this},o.prototype.once=function(t,e){const n=function(){e.call(this),this.off(t,n)};return this.on(t,n),this},o.prototype.off=function(t,e){var n=t.toLowerCase();if(e)this.node.removeEventListener(n,e,!1);else for(var o=this.bus.__s.length-1;o>=0;o--)this.node.removeEventListener(n,this.bus.__s[o],!1);return this.bus.off(n,e),this},o.prototype.trigger=function(t,e){return this.bus.trigger(t,e),this},r.lib={},r.prototype.append=function(t){this.node.append(t);for(var e in this.node.refs)this.refs[e]||(this.refs[e]=this.node.refs[e]);return this},r.prototype.getRoot=function(){return this.node.getRoot()},r.prototype.getEl=function(){return this.node.getEl()},r.prototype.on=function(t,e){return this.bus.on(t,e),this},r.prototype.once=function(t,e){return this.bus.once(t,e),this},r.prototype.off=function(t,e){return this.bus.off(t,e),this},r.prototype.trigger=function(t,e){return this.bus.trigger(t,e),this},r.create=function(t,e){function n(t,n){let o=Array.isArray(t)?t:n||[];if(this.props=s(t)?t:{},this.bus=new l({target:this}),this.refs={},this.ref=this.props.ref,e.constructor&&e.constructor.call(this,this.props),e.render){this.node=e.render.call(this,this.props),this.ref=this.props.ref||this.node.ref;for(var r in this.node.refs)this.refs[r]||(this.refs[r]=this.node.refs[r]);this.append(o)}}for(var o in r.prototype)n.prototype[o]=r.prototype[o];e.append&&(n.prototype.append=function(t){if(t){t=[].concat(t),e.append.call(this,t);for(var n=0,o=t.length;n<o;n++)f.call(this,t[n])}});for(o in e)"render"!==o&&"append"!==o&&(n.prototype[o]=e[o]);return r.lib[t]=n,n},i.onAttr=function(t,e){o.__onAttr[t.toLowerCase()]=e},i.onCreate=function(t){o.__onCreate.push(t)},i.fn=function(t,e){o.prototype[t]=e,r.prototype[t]=function(e,n,o){return this.node[t](e,n,o),this};for(var n in r.lib)r.lib[n].prototype[t]=r.prototype[t]},i.create=r.create,t.exports=i},function(t,e){t.exports=function(t){return"[object Object]"===Object.prototype.toString.call(t)}},function(t,e){t.exports=function(t){var e=(t?Object.prototype.toString.call(t):"").substring(8);return 0===e.indexOf("HTML")||0===e.indexOf("SVG")}},function(t,e){t.exports=function(t){const e=t.ref;e&&!this.refs[e]&&(this.refs[e]=t),Object.assign(this.refs,t.refs)}},function(t,e,n){const{MOUNTED:o}=n(0);t.exports=function t(e){const n=e.childNodes;if(document.body.contains(e)&&-1===o.indexOf(e)){o.push(e),e.dispatchEvent(new Event("mount",{bubbles:!1}));for(var r=0,i=n.length;r<i;r++)t(n[r])}}},function(t,e,n){const{MOUNTED:o}=n(0);t.exports=function t(e){const n=e.childNodes,r=o.indexOf(e);if(-1!==r){o.splice(r,1),e.dispatchEvent(new Event("unmount",{bubbles:!1}));for(var i=0,s=n.length;i<s;i++)t(n[i])}}},function(t,e,n){const o=n(1);t.exports=function(t,e){var n=[];return"object"==typeof e?(e.x&&n.push(o(t,e.x)),e.y&&n.push(o(t,e.y)),e.z&&n.push(o(t,e.z))):n.push(o(t,e)),t+"("+n.join(", ")+")"}},function(t,e){function n(t){this.__t=t.target||this,this.__s={}}n.prototype.once=function(t,e){var n=this,o=function(r){n.off(t,o),e.call(n.target,r)};this.on(t,o)},n.prototype.off=function(t,e){const n=t.toLowerCase(),o=(this.__s[n]||[]).indexOf(e);return o>-1?this.__s[n].splice(o,1):this.__s[n]=[],this},n.prototype.on=function(t,e){return t=t.toLowerCase(),"function"==typeof e&&(this.__s[t]=(this.__s[t]||[]).concat(e)),this},n.prototype.trigger=function(t,e){for(var n=(this.__s[t.toLowerCase()]||[]).slice(),o=0,r=n.length;o<r;o++)n[o].call(this.__t,e);return this},t.exports=n}]);
