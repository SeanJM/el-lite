...
module.exports = function (t) {
  ...
  "use strict";
  function o(t, e, r) {
    return i.lib[t] ? new i.lib[t].constructor(e, r) : t instanceof Text || t instanceof Comment ? t : "body" === t ? f : new n(t, e, r);
  }var n = r(1),
      i = r(12),
      s = r(13),
      u = r(3),
    ...
    n.prototype[t] = e, i.prototype[t] = i.__extend(t), s.prototype[t] = s.__extend(t);for (var r in i.lib) {
      i.lib[r].constructor.prototype[t] || (i.lib[r].constructor.prototype[t] = i.prototype[t]);
    }
  ...
  }, o.id = n.id, o.create = i.create, o.lib = i.lib, t.exports = o;
}, function (t, e, r) {
  "use strict";
  ...
  function o() {}var n = r(2),
    ...
    function r(e, r) {
      var i = Array.isArray(e) ? e : r || [],
          f = o.lib[t].body;this.props = n(e) ? e : {}, this.bus = new s({ target: this }), this.refs = {}, this.ref = this.props.ref, this.tagName = t;for (var p in u.__defaultProps) {
        this.props[p] || (this.props[p] = u.__defaultProps[p]);
      }if (f.constructor && f.constructor.call(this, this.props), f.render) {
        if (this.node = f.render.call(this, this.props), void 0 === this.node) throw new Error('Component "' + t + '" does not return a valid element.');this.ref = this.props.ref || this.node.ref;for (var a in this.refs) {
      ...
      "append" !== f && (r.prototype[f] = e[f]);
    }return o.lib[t] = { constructor: r, body: e }, r;
  }, t.exports = o;
}, function (t, e, r) {
  "use strict";
  function o(t) {
